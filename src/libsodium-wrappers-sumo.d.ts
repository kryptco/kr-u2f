...
declare module 'libsodium-wrappers-sumo' {
  ...
  function crypto_auth_hmacsha256(message: string | Uint8Array | undefined, key: Uint8Array, outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array;
  function crypto_auth_hmacsha256(message: string | Uint8Array | undefined, key: Uint8Array, outputFormat: StringOutputFormat | null): string;
  ...
  function crypto_auth_hmacsha256_verify(tag: Uint8Array, message: string | Uint8Array | undefined, key: Uint8Array): boolean;
  function crypto_auth_hmacsha512(message: string | Uint8Array | undefined, key: Uint8Array, outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array;
  function crypto_auth_hmacsha512(message: string | Uint8Array | undefined, key: Uint8Array, outputFormat: StringOutputFormat | null): string;
  ...
  function crypto_auth_hmacsha512_verify(tag: Uint8Array, message: string | Uint8Array | undefined, key: Uint8Array): boolean;
  ...
  function crypto_hash_sha256(message: string | Uint8Array | undefined, outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array;
  function crypto_hash_sha256(message: string | Uint8Array | undefined, outputFormat: StringOutputFormat | null): string;
  function crypto_hash_sha512(message: string | Uint8Array | undefined, outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array;
  function crypto_hash_sha512(message: string | Uint8Array | undefined, outputFormat: StringOutputFormat | null): string;
  ...
  function crypto_onetimeauth(message: string | Uint8Array | undefined, key: Uint8Array, outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array;
  function crypto_onetimeauth(message: string | Uint8Array | undefined, key: Uint8Array, outputFormat: StringOutputFormat | null): string;
  function crypto_onetimeauth_final(state_address: onetimeauth_state_address, outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array;
  function crypto_onetimeauth_final(state_address: onetimeauth_state_address, outputFormat: StringOutputFormat | null): string;
  ...
  function crypto_onetimeauth_update(state_address: onetimeauth_state_address, message_chunk: string | Uint8Array | undefined): void;
  function crypto_onetimeauth_verify(hash: Uint8Array, message: string | Uint8Array | undefined, key: Uint8Array): boolean;
  ...
  function crypto_pwhash_scryptsalsa208sha256(keyLength: number, password: string | Uint8Array | undefined, salt: Uint8Array, opsLimit: number, memLimit: number, outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array;
  function crypto_pwhash_scryptsalsa208sha256(keyLength: number, password: string | Uint8Array | undefined, salt: Uint8Array, opsLimit: number, memLimit: number, outputFormat: StringOutputFormat | null): string;
  function crypto_pwhash_scryptsalsa208sha256_ll(password: string | Uint8Array | undefined, salt: string | Uint8Array | undefined, opsLimit: number, r: number, p: number, keyLength: number, outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array;
  function crypto_pwhash_scryptsalsa208sha256_ll(password: string | Uint8Array | undefined, salt: string | Uint8Array | undefined, opsLimit: number, r: number, p: number, keyLength: number, outputFormat: StringOutputFormat | null): string;
  function crypto_pwhash_scryptsalsa208sha256_str(password: string | Uint8Array | undefined, opsLimit: number, memLimit: number): string;
  function crypto_pwhash_scryptsalsa208sha256_str_verify(hashed_password: string, password: string | Uint8Array | undefined): boolean;
  ...
  function crypto_shorthash_siphashx24(message: string | Uint8Array | undefined, key: Uint8Array, outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array;
  function crypto_shorthash_siphashx24(message: string | Uint8Array | undefined, key: Uint8Array, outputFormat: StringOutputFormat | null): string;
  ...
  function crypto_sign_ed25519_sk_to_pk(privateKey: Uint8Array, outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array;
  function crypto_sign_ed25519_sk_to_pk(privateKey: Uint8Array, outputFormat: StringOutputFormat | null): string;
  function crypto_sign_ed25519_sk_to_seed(privateKey: Uint8Array, outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array;
  ...
  function crypto_stream_chacha20_ietf_xor(input_message: string | Uint8Array | undefined, nonce: Uint8Array, key: Uint8Array, outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array;
  function crypto_stream_chacha20_ietf_xor(input_message: string | Uint8Array | undefined, nonce: Uint8Array, key: Uint8Array, outputFormat: StringOutputFormat | null): string;
  function crypto_stream_chacha20_ietf_xor_ic(input_message: string | Uint8Array | undefined, nonce: Uint8Array, nonce_increment: number, key: Uint8Array, outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array;
  function crypto_stream_chacha20_ietf_xor_ic(input_message: string | Uint8Array | undefined, nonce: Uint8Array, nonce_increment: number, key: Uint8Array, outputFormat: StringOutputFormat | null): string;
  ...
  function crypto_stream_chacha20_xor(input_message: string | Uint8Array | undefined, nonce: Uint8Array, key: Uint8Array, outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array;
  function crypto_stream_chacha20_xor(input_message: string | Uint8Array | undefined, nonce: Uint8Array, key: Uint8Array, outputFormat: StringOutputFormat | null): string;
  function crypto_stream_chacha20_xor_ic(input_message: string | Uint8Array | undefined, nonce: Uint8Array, nonce_increment: number, key: Uint8Array, outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array;
  function crypto_stream_chacha20_xor_ic(input_message: string | Uint8Array | undefined, nonce: Uint8Array, nonce_increment: number, key: Uint8Array, outputFormat: StringOutputFormat | null): string;
  ...
  function crypto_stream_xchacha20_xor(input_message: string | Uint8Array | undefined, nonce: Uint8Array, key: Uint8Array, outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array;
  function crypto_stream_xchacha20_xor(input_message: string | Uint8Array | undefined, nonce: Uint8Array, key: Uint8Array, outputFormat: StringOutputFormat | null): string;
  function crypto_stream_xchacha20_xor_ic(input_message: string | Uint8Array | undefined, nonce: Uint8Array, nonce_increment: number, key: Uint8Array, outputFormat?: Uint8ArrayOutputFormat | null): Uint8Array;
  function crypto_stream_xchacha20_xor_ic(input_message: string | Uint8Array | undefined, nonce: Uint8Array, nonce_increment: number, key: Uint8Array, outputFormat: StringOutputFormat | null): string;
